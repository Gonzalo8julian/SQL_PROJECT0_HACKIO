...
select "FirstName" as "Name", "Email" as "Email_Address", "Country" 
from "Customer" c 
...
select "PlaylistId" , "Name" as "Playlist_Name"
from "Playlist" p 
where "Name" = 'Music' ;
...
select "FirstName" as "First_Name", "LastName" as "Last_Name", "Title" 
from  "Employee" e 
